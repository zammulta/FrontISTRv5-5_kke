...
module mMaterial
  ...
  ! (Gaku Hashimoto, The University of Tokyo, 2014/02/13) <
      INTEGER, PARAMETER :: GOODMAN               = 161000
      INTEGER, PARAMETER :: GOODMAN_SEPARATION    = 161500
      ! > (Gaku Hashimoto, The University of Tokyo, 2014/02/13)
      INTEGER, PARAMETER :: DASHPOD_ELEMENT       = 162000
      INTEGER, PARAMETER :: RO                    = 163000
      INTEGER, PARAMETER :: SLIP_WEAKENING        = 164000
      INTEGER, PARAMETER :: GHE                   = 165000
	  
	  
	  !Added by Shanthanu, 2017/03/10
      INTEGER, PARAMETER :: CONCRETE		      = 170000
      INTEGER, PARAMETER :: REBAR   		      = 171000	  
	  !Added by Shanthanu, 2018/03/01
      INTEGER, PARAMETER :: REBAR2D   		      = 172000
      !Added by Shanthanu 2018/05/14
      INTEGER, PARAMETER :: CONCRETE_EMBED   	  = 173000
      integer :: concrete_embed_flag=0
      !Added by Shanthanu 2019/05/28
      INTEGER, PARAMETER :: BOND   	              = 174000
  ...
  ! (Gaku Hashimoto, The University of Tokyo, 2014/02/13) <
  INTEGER, PARAMETER :: M_GOODMAN_K1  = 71
  INTEGER, PARAMETER :: M_GOODMAN_K2  = 72
  INTEGER, PARAMETER :: M_GOODMAN_K3  = 73
  INTEGER, PARAMETER :: M_GOODMAN_C   = 74
  INTEGER, PARAMETER :: M_GOODMAN_PHI = 75
  INTEGER, PARAMETER :: M_GOODMAN_EPS = 76
  ! > (Gaku Hashimoto, The University of Tokyo, 2014/02/13)
  INTEGER, PARAMETER :: M_DASHPOD_VP = 77
  INTEGER, PARAMETER :: M_DASHPOD_VS = 78
...
contains
  ...
  subroutine finalizeMaterial( material )
    ...
    if (material%mtype==GOODMAN) return
